...
- **break:** Replace `LBSinglePresenter.initReducer()` with constructor-injected `LBSingleReducerFactory`
...
- Keep constructor-injected `LBSingleReducerFactory` as the default `LBSinglePresenter` reducer creation path
