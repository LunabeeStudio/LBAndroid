...
class TimerReducerFactory @Inject constructor() :
    LBSingleReducerFactory<TimerUiState, TimerNavScope, TimerAction> {
    /**
     * Creates the reducer instance using the runtime owned by the presenter.
     */
    override fun create(runtime: LBReducerRuntime<TimerAction>): TimerReducer = TimerReducer(
