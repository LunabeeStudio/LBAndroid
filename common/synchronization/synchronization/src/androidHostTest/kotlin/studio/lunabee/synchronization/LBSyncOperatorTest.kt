...
class LBSyncOperatorTest {
    ...
    private fun freshStore(scope: CoroutineScope): SyncTimestampStore {
        val fileName = "sync_operator_${counter++}_${nextRandom()}.preferences_pb"
...
) : LBSyncManager<OperatorServerObj, OperatorLocalObj, Nothing>(timestampStore = store, scope = scope) {

    init {
        retryTempo = null
    }

    override val syncKey: String = syncKey
