...
/**
 * The single process-wide [DataStore] backing every [DataStoreSyncTimestampStore]. The
...
/**
 * Returns a [SyncTimestampStore] backed by the single process-wide DataStore, built from the
 ...
 * ```
 */
fun Context.dataStoreSyncTimestampStore(): SyncTimestampStore =
    DataStoreSyncTimestampStore(applicationContext.syncDataStore)
